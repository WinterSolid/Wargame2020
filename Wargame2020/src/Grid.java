...
public class Grid {
     ...
     * Method that affects a Location  based on a given row and column will be subtracted

     * by one when used in the grid in order to correlate
     *the given numbers with the proper rows and columns on the game board*/
     ...
     * using dashes for unguessed spots, X's for hits, and O's for misses*/
     ...
     * @param s should be the ship being added
